...
SECRET_KEY = 'django-insecure-_)n2*m1y05txpkvjlu168bi^1#x!fanf2_apvk!cqnvq@_58=='
...
INSTALLED_APPS = [
    ...
    # Third Party Apps
    'rest_framework',
    #'rest_framework_simplejwt.token_blacklist', #There is problem occurs in the two apps
    #'drf_yasg',
